import image1 from "@/../public/images/personal-loan/personal-loan-every-one-1.png";
import image2 from "@/../public/images/personal-loan/personal-loan-every-one-2.png";
        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="col-start-1 col-end-13 grid-cols-7 gap-4 sm:grid lg:col-end-9 xl:col-end-8 xxl:gap-6">
            <Image
              ...
              width={416}
              height={503}
              alt="Personal Loan for everyone one"
            ...
            <Image
              ...
              width={306}
              height={503}
              alt="Personal Loan for everyone two"
          ...
          <div className="col-start-1 col-end-13 lg:col-start-9">
            ...
            <SectionTitle
              text="Personal loans for everyone"
            ...
            <ul className="spt32px flex flex-col gap-4">
              <li className="fade-top flex items-center gap-3">
                <IconCircleCheck />{" "}
...
export default PersonalLoanEveryOne;
