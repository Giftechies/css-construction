import image2 from "@/../public/images/home-loan/document-1.png";
import image1 from "@/../public/images/home-loan/document-2.png";
      ...
      <div className="container">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-start-1 col-end-13 lg:col-start-1 lg:col-end-6">
            <SectionSubTitle text="Home loan" />
            <SectionTitle
          ...
          <div className="col-start-1 col-end-13 grid-cols-7 gap-4 max-lg:row-start-1 sm:grid lg:col-start-6 lg:col-end-13 xxl:gap-6">
            <Image
              ...
              width={306}
              height={503}
              alt="Home Loan for everyone two"
              className="appear-down col-start-1 col-end-4"
            />
            <Image
              src={image1}
              width={416}
              height={503}
              alt="Home Loan for everyone one"
              className="appear-down col-start-4 col-end-8 max-sm:mt-3"
            />
          </div>
        </div>
      </div>
...
export default HomeDocumentRequired;
