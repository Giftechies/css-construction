...
const Vision = () => {
  return (
    <section>
      <div class="parallax-bg relative w-full h-[70vh]  bg-[url(https://media.istockphoto.com/id/615926270/photo/night-in-warsaw.webp?a=1&b=1&s=612x612&w=0&k=20&c=j-zWimePBOwt-oqaFlaVJzECEW4zc9nyOExxPZuJ5l4=)]   flex items-center justify-center">
