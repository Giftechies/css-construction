import image from "@/../public/images/business-loan/business-loan-everyone.png";
        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="col-start-1 col-end-13 grid-cols-7 gap-4 lg:col-end-9 xl:col-end-8 xxl:gap-6">
            <Image
              ...
              width={746}
              height={503}
              alt="Business Loan for everyone"
              className="fade-top"
            />
          </div>
          <div className="col-start-1 col-end-13 lg:col-start-9">
            ...
            <SectionTitle
              text="Business loans for everyone"
...
export default BusinessLoanEveryOne;
