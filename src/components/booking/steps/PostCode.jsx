...
export default function PostCode() {
 const POSTCODE = [
  ...
  "EC", "EN1", "EN2", "EN3", "EN4", "EN5", "EN6", "EN7", "EN8", "EN9",
  "EN10", "EN11", "GU1", "GU2", "GU3", "GU4", "GU5", "GU6", "GU7", "GU8",
  "GU9", "GU10", "GU11", "GU12", "GU14", "GU15", "GU16", "GU17", "GU18",
  "GU19", "GU20", "GU21", "GU22", "GU23", "GU24", "GU25", "GU46", "GU47",
  "GU51", "GU52",
  "HA0", "HA1", "HA2", "HA3", "HA4", "HA5", "HA6", "HA7", "HA8", "HA9",
  "KT1", "KT2", "KT3", "KT4", "KT5", "KT6", "KT7", "KT8", "KT9",
  "KT10", "KT11", "KT12", "KT13", "KT14", "KT15", "KT16", "KT17",
  "KT18", "KT19", "KT20", "KT21", "KT22", "KT23", "KT24",
  ...
  "SL1", "SL2", "SL3", "SL4", "SL5", "SL6", "SL7", "SL8", "SL9", "SLO",
  "SM1", "SM2", "SM3", "SM4", "SM5", "SM6", "SM7",
  "SW1", "SW1A", "SW1P", "SW1V", "SW1W", "SW1X", "SW1Y",
  "SW2", "SW3", "SW4", "SW5", "SW6", "SW7", "SW8", "SW9",
  "SW10", "SW11", "SW12", "SW13", "SW14", "SW15", "SW16",
  "SW17", "SW18", "SW19", "SW20",
  "TN1", "TN2", "TN4", "TN9", "TN10", "TN11", "TN12", "TN13", "TN14", "TN15", "TN16",
  "TN23", "TN24", "TN26", "TN27",
  "TW1", "TW2", "TW3", "TW4", "TW5", "TW6", "TW7", "TW8", "TW9",
  "TW10", "TW11", "TW12", "TW13", "TW14", "TW15", "TW16", "TW17",
  "TW18", "TW19", "TW20",
  "UB1", "UB2", "UB3", "UB4", "UB5", "UB6", "UB7", "UB8", "UB9",
  "UB10", "UB11",
  "W1D", "W1G", "W1H", "W1J", "W1K", "W1U",
  ...
  // ✅ Custom MenuList with data-lenis-prevent
  ...
  return (
    <div>
     <h5 className=" h5 text-center " ><span className=" text-primary font-semibold   " >Step 1:</span> Select the postcode area where your skip will be delivered.</h5>
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <div className="mt-6 flex flex-col justify-center space-y-2">
            <label className="h6 block text-center font-bold">Postcode*</label>
  ...
  classNames={{
    menu: () => "bg-white-1 shadow-lg border rounded-md z-[9999] tracking-wider",
    menuList: () =>
    ...
    option: ({ isFocused, isSelected }) =>
      `px-3 py-2 cursor-pointer tracking-wider ${
        isSelected ? "bg-primary/60 text-white" : isFocused ? "bg-gray-100" : ""
      }`,
    singleValue: () => "tracking-wider text-primary font-semibold",
  }}
  styles={{
    control: (provided, state) => ({
      ...provided,
      borderRadius: ".5rem", // makes it rounded
      borderColor: state.isFocused ? "#F39740" : "#ccc", // focus border color
      boxShadow: state.isFocused ? "0 0 0 1px #ED7527" : "none",
      minHeight: 48,
      width:850,
      padding: "0 0.75rem",
    }),
...
/>
            ...
            {fieldState.error && (
              <p className="mx-auto mt-2 text-sm text-red-500">
