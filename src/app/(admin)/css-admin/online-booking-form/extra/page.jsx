...
export default function ExtraPage() {
  ...
  return (
    <section className="p-6  border-gray-200 rounded-md">
      ...
      {bulkMessage && (
        <div
          className={`fixed top-5 right-5 px-4 py-2 rounded shadow-lg text-white-1 z-50 ${
      ...
      <div className="mb-6 flex flex-wrap justify-between items-center gap-2">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button className=" text-white-1" >Add New Extra</Button>
          </DialogTrigger>
          ...
          <DialogContent>
            ...
            <form onSubmit={handleCreate} className="flex flex-col gap-3 mt-2">
              ...
              <div className="flex gap-3 mt-4">
                <Button type="submit" disabled={creating} className="bg-primary text-white-1">
                  {creating ? (
                    <>
                ...
                <label
                  htmlFor="bulkFile"
                  className="cursor-pointer bg-primary text-white-1 rounded px-4 py-1 hover:bg-primary/80"
                >
                  Import Bulk
                </label>
              </div>
                  ...
                  {editId === item._id ? (
                    <>
                      <Button
                        ...
                        disabled={updating}
                        className="bg-primary text-white-1"
                      >
